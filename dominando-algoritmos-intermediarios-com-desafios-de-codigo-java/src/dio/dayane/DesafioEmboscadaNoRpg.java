 ...
 * escura, o seu personagem foi emboscado por um terrível goblin. 
 * Como em todo bom RPG, temos alguns parâmetros que definem os status 
 * dos personagens:
 ...
 * O dado é um modificador desses parâmetros. Quando você joga o dado o valor dele 
 * deve ser somado ao seu ataque ou a sua defesa. Quando o valor do dado for maior que 8 e 
 * menor que 10, o jogador tira um crítico e essa soma deve ser DOBRADA.
...
public class DesafioEmboscadaNoRpg {
